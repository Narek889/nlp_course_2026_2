...
Usage:
    ...
    For low recources
    python homework-5.py --data rus.txt --epochs 1 --batch 64 --hidden 512 --layers 2
...
def main():
    ...
    if args.translate is not None:
        ...
        # ✅ Restore architecture dims from what was actually trained
        ...
        # Rebuild model with the saved dims, then load weights
        encoder = Encoder(len(src_vocab), args.embed, args.hidden,
                          args.layers, args.dropout)
        decoder = Decoder(len(tgt_vocab), args.embed, args.hidden,
                          args.layers, args.dropout)
